...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                elif self.ant.container == False and insect.container:
    ...
    def remove_insect(self, insect):
        ...
        """
        if insect.name == 'Queen' and insect.if_true_queen:
            return
        if insect.is_ant:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while ans == None and now_place != hive:
            ans=random_or_none(now_place.bees)
...
class LongThrower(ThrowerAnt):
    ...
    def nearest_bee(self, hive):
        now_range = 0
        now_place = self.place
        while now_range < self.min_range and now_place != hive:
            now_place = now_place.entrance
            now_range += 1
        ans = None
        while ans == None and now_place != hive:
...
class ShortThrower(ThrowerAnt):
    ...
    def nearest_bee(self, hive):
        ...
        now_place = self.place
        ans = None
        while ans == None and now_place != hive and now_range<=self.max_range:
            ans=random_or_none(now_place.bees)
            now_place = now_place.entrance
            now_range += 1
        return ans
    ...
    def action(self, colony):
        ...
        if self.digesting > 0:
            ...
            if the_bee:
                ...
                the_bee.reduce_armor(the_bee.armor)     
        # END Problem 10
...
# END Problem 13
    ...
    def __init__(self):
        ...
        self.if_true_queen = True
        if QueenAnt.total_queen>1:
            self.if_true_queen = False
        Ant.__init__(self)
        # END Problem 13
    ...
    def action(self, colony):
        ...
        """
        # BEGIN Problem 13
        if self.if_true_queen:
            ScubaThrower.action(self, colony)
            now_place=self.place.exit
            while now_place != None:
                if now_place.ant:
                    if now_place.ant.container == False:
                        if not (now_place.ant in self.ant_list):
                            now_place.ant.damage = now_place.ant.damage*2
                            self.ant_list.append(now_place.ant)
                    else:
                        if now_place.ant.ant and not (now_place.ant.ant in self.ant_list):
                            now_place.ant.ant.damage = now_place.ant.ant.damage*2
                            self.ant_list.append(now_place.ant.ant) 
                        if now_place.ant.damage and not (now_place.ant in self.ant_list):
                            now_place.ant.damage = now_place.ant.damage*2
                            self.ant_list.append(now_place.ant)
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0 and self.if_true_queen:
            bees_win()
        # END Problem 13
